...
import { LogoutLink, PortalLink } from "@kinde-oss/kinde-auth-nextjs";
...
const user = {
  ...
  given_name: "Great Bear",
  given_mail: "abc@example.com"
}
export default function UserNav() {
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" side="right" setoffset={8} className="w-[200px]">
        <DropdownMenuLabel className="font-normal flex items-center gap-2 px-1 py-1.5">
          ...
          <div className="grid flex-1 text-left text-sm leading-tight">
            ...
            <p className="text-muted-foreground truncate text-xs">{user.given_mail}</p>
          </div>
        </DropdownMenuLabel>
